...
public:
	...
	BEGIN_MSG_MAP(thisClass)
		...
		// Menu
			...
			COMMAND_ID_HANDLER(ID_VIEW_EVENTBAR, OnViewEventBar)
		// Reflect
	...
	BEGIN_UPDATE_UI_MAP(thisClass)
		...
		UPDATE_ELEMENT(ID_VIEW_EVENTBAR, UPDUI_MENUPOPUP)
	END_UPDATE_UI_MAP()
	...
	LRESULT OnViewEventBar(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
