...
void CPlanDoc::SetPathName(LPCTSTR lpszPathName, BOOL bAddToMRU) 
{
	CString str=((CPlanApp *)AfxGetApp())->GetProfileString(SETTINGS,CURRENTDOCUMENT,_T(""));
	if(str!=_T(""))
		CDocument::SetPathName(str, bAddToMRU);
	else
