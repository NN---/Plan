...
public:
	...
	BEGIN_MSG_MAP(thisClass)
		...
		COMMAND_ID_HANDLER(IDC_EMPTY, OnEmpty)
		COMMAND_ID_HANDLER(IDC_ADD, OnEventCmd)
		COMMAND_ID_HANDLER(IDC_UPDATE, OnEventCmd)
		COMMAND_ID_HANDLER(IDC_DELETE, OnEventCmd)
