...
typedef CArray<CTime,CTime> CTimeArray;
typedef CArray<Schedule,Schedule> ScheduleArray;
...
// Attributes
public:
	PCEventIDArray &GetaID();
	LPBYTEArray &GetaData();
	CUIntArray &GetaDataSize();
	CTimeArray &GetaTime();
	ScheduleArray &GetaSchedule();
private:
	PCEventIDArray aID;
	LPBYTEArray aData;
	CUIntArray aDataSize;
	CTimeArray aTime;
	ScheduleArray aSchedule;
